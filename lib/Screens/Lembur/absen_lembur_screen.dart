...
import 'package:presensi_sabu_raijua/Screens/Lembur/absen_lembur_post.dart';
...
class AbsenLemburScreen extends StatefulWidget {
...
class _AbsenLemburScreenState extends State<AbsenLemburScreen> {
  ...
  double la = 0;
  double lo = 0;
  double PembatasJarak = Core().MaximalJarak;
  int StatusAbsenLembur = 1;
  ...
  getCurrentLocation() async {
    ...
    PembatasJarak = prefs.getDouble("Radius")!;
    bool serviceEnabled;
  ...
  Future<String> getDataDash(String UUID) async {
    ...
    setState(() {
      StatusLembur = resBody['message'];
      StatusAbsenLembur = resBody['message']['status'];
    });
    print(StatusAbsenLembur);
    return "";
  }
                            ...
                            if (_image == null) {
                              ...
                              AbsenLemburPost.connectToApi(
                                ...
                                if (value!.status_kode == 200) {
                                  ...
                                  _showMyDialog(
                                      "Absensi Lembur", value.message);
                                }
                              });
                            }
                          } else {
                            _showMyDialog(
                                "Absensi Lembur", "Lokasi Anda Terlalu Jauh");
                          }
                        },
                      ),
              ))),
